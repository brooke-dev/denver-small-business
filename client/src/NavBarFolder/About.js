...
const About = () => {
    return (
      ...
      <h1>About</h1>
      <p>
        Welcome to the Busy Bee! A community built for the person who loves to shop sustainably, and locally. Small businesses struggle by the day to promote themselves on all of the various social media platforms! This application is meant to reduce the needs of both the business and the consumer. A consumer is able to search and sort through the list of small businesses, so that they can review, and favorite their local business!
      </p>
      
      <h2>Application Coding Details</h2>
      <p>
          This application was built with React v18, MDB Bootstrap, and Ruby on Rails for the back end database. 
      </p>
